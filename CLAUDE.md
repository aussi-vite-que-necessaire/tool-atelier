...
- **Merge de PR → `main` = palier d'intégration** : `https://app.preview.contentos.ch`, base clonée intégralement depuis la prod (jamais détruite), chaque déploiement gardé par un smoke `/healthz`. C'est le palier stable où l'on valide avant prod.
