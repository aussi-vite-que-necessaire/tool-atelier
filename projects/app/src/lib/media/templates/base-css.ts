...
// Inliné en constante TS car le bundler Next (sortie standalone) ne trace pas les
// readFileSync relatifs au module compilé : un .css ne serait pas copié à côté du
// bundle au runtime.
