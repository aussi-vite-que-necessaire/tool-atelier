...
export function DashboardStats({
  ...
  const stats: Stat[] = [
    { href: '/cast/posts', label: 'Posts', value: posts, icon: FileText },
    { href: '/cast/calendar', label: 'Planifiés', value: scheduled, icon: CalendarClock },
    { href: '/cast/calendar', label: 'Publiés', value: published, icon: Send },
  ];
  return (
