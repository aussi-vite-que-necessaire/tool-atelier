...
base="Dis ce que tu veux faire — le dev de feature passe par superpowers ; skills atelier : \`/nouveau-projet\`, \`/noter-idee\`, \`/travailler-infra\`, \`lab-ssh\`. Jamais de commit sur main ; push de branche = preview, PR mergée = prod."
