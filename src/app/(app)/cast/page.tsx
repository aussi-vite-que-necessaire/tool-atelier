...
const QUICK_ACTIONS = [
  { href: '/cast/posts', label: 'Créer un post', icon: PenSquare, variant: 'default' as const },
  { href: '/cast/calendar', label: 'Calendrier', icon: CalendarDays, variant: 'outline' as const },
];
